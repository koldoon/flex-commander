...
//--------------------------------------
    ...
    public class UITextField extends FlexTextField implements IAutomationObject, IIMESupport,
         ...
         */
        mx_internal static const TEXT_WIDTH_PADDING:int = 0 ;
         ...
         *  of a TextField that can display the text without clipping.
         */
        mx_internal static const TEXT_HEIGHT_PADDING:int = 0;
        ...
        public function get measuredWidth():Number {
            ...
            return Math.ceil(Math.abs((textWidth * m.a / m.d)) + TEXT_WIDTH_PADDING);
        }
        ...
        public function truncateToFit(truncationIndicator:String = null):Boolean {
            ...
            // with verdana.ttf.
            if (originalText != "" && textWidth > w + 0.00000000000002) {
