...
//   [Style(name="backgroundColor", type="uint", format="Color", inherit="no")]
     ...
     *  @productversion Flex 3
     */
    public class Label extends UIComponent implements IDataRenderer, IDropInListItemRenderer,
        IListItemRenderer, IFontContextComponent, IDisplayText {
        ...
        public var additionalMeasurementWidth:int = 20;
        public var additionalMeasurementHeight:int = 20;
        ...
        override protected function measure():void {
            ...
            textFieldBounds.width += additionalMeasurementWidth; // TODO: Find a better workaround
            textFieldBounds.height += additionalMeasurementHeight; // TODO: Find a better workaround
...
//            }
            ...
            if (verticalAlign == "middle") {
                ...
                textField.setActualSize(unscaledWidth - paddingLeft - paddingRight,
                    Math.min(unscaledHeight - paddingTop - paddingBottom, textHeight));

                textField.x = paddingLeft;
                textField.y = (unscaledHeight - (paddingTop + paddingBottom + textHeight)) / 2;
            }
            else {
                textField.setActualSize(unscaledWidth - paddingLeft - paddingRight,
        ...
        public function get isTruncated():Boolean {
            var paddingLeft:Number = getStyle('paddingLeft') || 0;
            var paddingRight:Number = getStyle('paddingRight') || 0;
            return (textWidth + paddingLeft + paddingRight) > width;
        }
    }
